...
class FieldContextImpl {
    ...
    fetch(callback) {
        ...
        operationPromise = operationPromise.then((payload) => new FieldInstance(operationVersion, payload, instance._solution.assistantSid, instance._solution.taskSid, instance._solution.sid));
        operationPromise = instance._version.setPromiseCallback(operationPromise, callback);
        return operationPromise;
    }
    /**
...
function FieldListInstance(version, assistantSid, taskSid) {
    ...
    instance.create = function create(params, callback) {
        ...
        operationPromise = operationPromise.then((payload) => new FieldInstance(operationVersion, payload, instance._solution.assistantSid, instance._solution.taskSid));
        operationPromise = instance._version.setPromiseCallback(operationPromise, callback);
        return operationPromise;
    };
    instance.page = function page(params, callback) {
        ...
        operationPromise = operationPromise.then((payload) => new FieldPage(operationVersion, payload, instance._solution));
        operationPromise = instance._version.setPromiseCallback(operationPromise, callback);
        return operationPromise;
    };
    ...
    instance.getPage = function getPage(targetUrl, callback) {
        ...
        let pagePromise = operationPromise.then((payload) => new FieldPage(instance._version, payload, instance._solution));
